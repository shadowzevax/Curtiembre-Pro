...
export default function RemisionView({ orden, cliente }) {
    if (!orden || !cliente) return null;

    const handlePrint = () => {
        const printContents = document.getElementById('remision-printable').innerHTML;
                ...
                <div className="invoice-container">
                    <div className="header">
                        ...
                        <div className="remision-box">
                            <div className="title">REMISIÓN</div>
                    ...
                    <div className="info-row">
                        ...
                        <div className="field" style={{ flexGrow: 3 }}><label>Entregado a:</label><span>{cliente.nombre}</span></div>
                    </div>
