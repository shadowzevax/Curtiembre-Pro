...
const menuItems = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { title: "Otros medios de dinero", url: createPageUrl("FinanzasOtrosMedios"), icon: Calculator },
            { title: "Cuentas por Cobrar", url: createPageUrl("FinanzasCuentasPorCobrar"), icon: Calculator },
            { title: "Cuentas por Pagar", url: createPageUrl("FinanzasCuentasPorPagar"), icon: Calculator },
    ...
    },
    {
        ...
        subItems: [
            ...
            { title: "Catálogo de Placas", url: createPageUrl("CatalogoPlacas"), icon: Package },
            { title: "Catálogo de Tipos de Procesos", url: createPageUrl("CatalogoTiposProceso"), icon: Package },
...
export default function Layout({ children, currentPageName }) {
    ...
    const getPageTitle = (name) => {
        ...
        const titles = {
            ...
            'FinanzasCaja': 'Caja',
            'FinanzasBancos': 'Bancos',
            'FinanzasOtrosMedios': 'Otros medios de dinero',
            'FinanzasCuentasPorCobrar': 'Cuentas por Cobrar',
            'FinanzasCuentasPorPagar': 'Cuentas por Pagar',
            'FinanzasTesoreria': 'Tesorería',
